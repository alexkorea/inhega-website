          ...
          <div className={styles.grid}>
            <div className={styles.info}>
              <div className="fade-up">
                <h2 className="text-h2" style={{ color: 'var(--navy)', marginBottom: '2rem' }}>联系方式</h2>
                {[
                  {
                    icon: (
                ...
                <div style={{ marginTop: '1.5rem', padding: '1.25rem', background: 'var(--white)', borderRadius: '12px', border: '1px solid var(--border)' }}>
                  <p style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--navy)', marginBottom: '0.75rem' }}>即时通讯（中文服务）</p>
                  <p style={{ fontSize: '0.875rem', color: 'var(--slate)' }}>微信 · KakaoTalk · LINE · WhatsApp</p>
            ...
            <div className={`fade-up delay-1`}>
              {status === 'success' ? (
                <div style={{ background: 'var(--white)', borderRadius: '20px', padding: '3rem', textAlign: 'center', border: '1px solid var(--border)' }}>
                  ...
                  <button onClick={() => { setStatus('idle'); setForm({ name: '', phone: '', email: '', service: '', message: '', language: 'zh' }) }} className="btn btn-secondary">
