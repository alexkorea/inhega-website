                ...
                <div
                  className={[
                    "flex h-10 w-10 items-center justify-center rounded-full border-2 text-sm font-semibold transition-colors",
                      ...
                      ? "border-[#f36c24] bg-[#f36c24] text-white"
                      : active
                      ? "border-[#f36c24] bg-white text-[#f36c24]"
          ...
          <div className="mt-10 flex items-center justify-between border-t border-slate-200 pt-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[#f36c24] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#d14904] disabled:cursor-not-allowed disabled:bg-[#f36c24]/50"
              >
                {step === 3
                  ? status === "sending"
                    ? "전송 중..."
          ...
          return (
            <button
              ...
              className={[
                ...
                active
                  ? "border-[#f36c24] bg-[#ffe6d5] text-[#9a3412] shadow-sm"
                ...
                return (
                  <label
                    ...
                    className={[
                      ...
                      active
                        ? "border-[#f36c24] bg-[#ffe6d5] text-[#9a3412]"
                  ...
                  >
                    <input
                      ...
                      className="h-4 w-4 border-slate-300 text-[#f36c24] focus:ring-[#f36c24]"
                    />
                    <span>{opt}</span>
                  </label>
                )
...
const inputCls =
  "block w-full rounded-lg border border-slate-300 px-4 py-3 text-sm text-slate-900 placeholder-slate-400 transition-colors focus:border-[#f36c24] focus:outline-none focus:ring-1 focus:ring-[#f36c24]"
