...
const contactInfo = [
  { icon: Phone, title: "전화 문의", primary: "02-363-2251", secondary: "월~금 9:30 AM - 5:30 PM" },
  { icon: Mail, title: "이메일 문의", primary: "5000meter@gmail.com", secondary: "상세한 문의 환영" },
  { icon: MapPin, title: "오시는 길", primary: "서울특별시 중구 퇴계로 324, 3층", secondary: "(성우빌딩)" },
]
      ...
      <main>
        ...
        <section className="relative pt-20 min-h-[400px] flex items-center">
          ...
          <div className="relative mx-auto max-w-7xl px-6 py-20 text-center text-white w-full">
            ...
            <p className="mt-4 text-lg text-white/80">업종과 상황에 맞는 맞춤형 행정 지원을 제공합니다</p>
          </div>
        </section>
              ...
              <div className="space-y-6">
                {contactInfo.map((item) => (
                  <div key={item.title} className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
                    <div className="flex items-start gap-4">
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-[#ffe6d5]/50">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-900">카카오톡 상담</h3>
                      <p className="mt-1 text-sm text-slate-500">카카오톡으로 간편하게 문의하세요.</p>
                      <button className="mt-3 rounded-lg bg-yellow-400 px-6 py-2.5 text-sm font-semibold text-slate-900 transition-colors hover:bg-yellow-500">카카오톡 문의</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="bg-slate-50 py-20">
          <div className="mx-auto max-w-7xl px-4 text-center">
            <h2 className="text-2xl font-bold text-slate-900">방문 상담도 환영합니다</h2>
            <p className="mt-4 text-slate-600">서울특별시 중구 퇴계로 324, 3층 (성우빌딩)</p>
            <p className="mt-2 text-sm text-slate-500">방문 전 전화 예약을 부탁드립니다.</p>
          </div>
        </section>
      </main>
      <Footer />
