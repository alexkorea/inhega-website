              ...
              <div className="max-w-7xl mx-auto px-6 w-full pb-10">
                <div className="max-w-3xl">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#f36c24] text-white text-xs font-medium rounded-full">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              <article className="flex-1 min-w-0">
                <Link
                  href="/blog"
                  className="inline-flex items-center gap-2 text-sm text-[#f36c24] hover:text-[#d14904] mb-8 transition-colors"
                >
                ...
                <div
                  ...
                  className="prose prose-gray max-w-none
                    ...
                    prose-h2:text-xl prose-h2:mt-14 prose-h2:mb-5 prose-h2:border-b-2 prose-h2:border-[#f36c24] prose-h2:pb-3 prose-h2:text-[#7c2d12]
                    prose-h3:text-lg prose-h3:mt-8 prose-h3:mb-3 prose-h3:text-[#9a3412]
                    prose-p:text-gray-700 prose-p:leading-relaxed prose-p:mb-5
                    prose-li:text-gray-700 prose-li:leading-relaxed
                    prose-strong:text-gray-900
                    prose-a:text-[#f36c24] prose-a:underline prose-a:underline-offset-2 prose-a:font-semibold
              ...
              <aside className="hidden lg:block lg:w-80 shrink-0">
                <div className="sticky top-24 space-y-8">
                  ...
                  <div className="bg-white rounded-2xl p-5 border border-slate-200">
                    <h3 className="font-semibold text-slate-900 mb-3 text-center text-sm">메신저 상담</h3>
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <div key={m.name} className="text-center">
                          <div className="w-full aspect-square rounded-lg overflow-hidden border border-slate-100 mb-1">
                  ...
                  {relatedPosts.length > 0 && (
                    <div className="bg-slate-50 rounded-2xl p-6">
                      <h3 className="font-semibold text-slate-900 mb-4">관련 글</h3>
                      <div className="space-y-4">
                        {relatedPosts.map((related) => (
                          ...
                          >
                            <h4 className="text-sm font-medium text-slate-900 group-hover:text-[#f36c24] transition-colors line-clamp-2">
                              {related.title}
                            </h4>
                  ...
                  {/* CTA Card */}
                  <div className="bg-[#f36c24] rounded-2xl p-6 text-white">
                    <h3 className="font-semibold mb-2">전문 상담이 필요하신가요?</h3>
                    <p className="text-orange-100 text-sm mb-4">
                      비전행정사사무소의 전문 행정사가 맞춤 상담을 제공합니다.
                    </p>
                    <Link
                      href="/contact"
                      className="inline-flex items-center justify-center w-full bg-white text-[#f36c24] font-medium text-sm h-10 rounded-lg hover:bg-[#ffe6d5]/50 transition-colors"
                    >
                      무료 상담 신청
                    </Link>
                  </div>
