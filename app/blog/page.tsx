...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.inhega.co.kr/blog",
  },
  openGraph: {
    title: "인허가 정보 블로그 - 비전행정사사무소",
    description:
      "인허가 업무에 필요한 유용한 정보와 실무 가이드를 제공합니다.",
    url: "https://www.inhega.co.kr/blog",
    siteName: "비전행정사사무소",
    type: "website",
              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="text-lg font-semibold text-slate-900 mb-2 group-hover:text-[#f36c24] transition-colors line-clamp-2">
                      {post.title}
                    </h2>
