    ...
    <section className="bg-slate-50 py-20">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="text-center mt-14">
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-lg bg-[#f36c24] px-8 py-3.5 text-sm font-semibold text-white hover:bg-[#d14904] transition-colors shadow-[0_4px_14px_rgba(243,108,36,0.35)] hover:-translate-y-0.5"
          >
            업무 상담 문의하기
          </Link>
        </div>
