...
export function Footer() {
  return (
    <footer className="bg-[#231f20] text-slate-300">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Brand */}
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 bg-[#f36c24] rounded-lg flex items-center justify-center">
      ...
      <div className="border-t border-[#3a3536]">
