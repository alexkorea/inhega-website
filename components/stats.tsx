      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link
              href="/about"
              className="inline-flex items-center justify-center rounded-lg bg-[#f36c24] px-7 py-3 text-sm font-semibold text-white hover:bg-[#d14904] transition-colors shadow-[0_4px_14px_rgba(243,108,36,0.35)] hover:-translate-y-0.5"
            >
              About Us 자세히 보기
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            {stats.map((stat, i) => (
              <div key={i} className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-[#f36c24] mb-2">
                  {stat.value}
                </div>
